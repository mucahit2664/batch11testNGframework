...
public void Test01(){
   ...
   // 2. softassert kullanarak amazon websitesine gittiginizi dogrulayin
    ...
    softAssert.assertTrue(logo.isDisplayed(),"sayafaya gidilemedi");
    // 2. softassert kullanarak amazon websitesine gittiginizi dogrulayin
...
//    arama kutusuna history yazdirip aratin
 WebElement dropDown=driver.findElement(By.id("searchDropdownBox"));
    ...
    //4. cikan kitaplardan 2. ve 5. kitabin isminde History kelimesinin gectigini dogrulayin
WebElement ikinciKitapElementi=driver.findElement(By.xpath("(//span[@class='a-size-medium a-color-base a-text-normal'])[2]"));
    WebElement besinciKitapElementi=driver.findElement(By.xpath("(//span[@class='a-size-medium a-color-base a-text-normal'])[5]"));
